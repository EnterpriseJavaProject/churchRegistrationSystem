...
$query = "SELECT * from  members where residence LIKE '%Yorog%' ";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE MEMBERS FROM YOROGO REPORT(BOLGATANGA)',0,1);
    }
