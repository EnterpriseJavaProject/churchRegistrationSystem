...
$query = "SELECT * from  members where region = 'Northern'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD | HOLY GHOST TEMPLE MEMBERS FROM NORTHERN REGION REPORT(BOLGATANGA)',0,1);
    }
