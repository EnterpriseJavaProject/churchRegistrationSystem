...
$query = "SELECT * from  members where region = 'Greater Accra'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD | HOLY GHOST TEMPLE MEMBERS FROM GREATER ACCRA REPORT(BOLGATANGA)',0,1);
    }
