...
$query = "SELECT * from  members where country = 'Burkina Faso'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA| HOLY GHOST TEMPLE MEMBERS FROM BURKINA FASO REPORT(BOLGATANGA)',0,1);
    }
