...
$query = "SELECT * from  members where department = 'Healing Voices'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE HEALING VOICES MEMBERS REPORT(BOLGATANGA)',0,1);
    }
