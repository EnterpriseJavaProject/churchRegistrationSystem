...
$query = "SELECT * from  members where country = 'Côte d'Ivoire'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA| HOLY GHOST TEMPLE MEMBERS FROM COTE d`IVOIRE REPORT(BOLGATANGA)',0,1);
    }
