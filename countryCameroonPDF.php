...
$query = "SELECT * from  members where country = 'Cameroon'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA| HOLY GHOST TEMPLE MEMBERS FROM CAMERRON REPORT(BOLGATANGA)',0,1);
    }
