...
$query = "SELECT * from  members where residence = 'Tindonsobligo'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD | HOLY GHOST TEMPLE MEMBERS FROM TINDONSOBLIGO REPORT(BOLGATANGA)',0,1);
    }
