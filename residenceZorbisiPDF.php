...
$query = "SELECT * from  members where residence LIKE '%Zorbi%' ";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE MEMBERS FROM ZORBISI REPORT(BOLGATANGA)',0,1);
    }
