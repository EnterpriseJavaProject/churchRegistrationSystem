...
$query = "SELECT * from  members where region = 'Savannah'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD | HOLY GHOST TEMPLE MEMBERS FROM SAVANNAH REGION REPORT(BOLGATANGA)',0,1);
    }
