...
$query = "SELECT * from  members where department = 'Royal Rangers'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE ROYAL RANGERS MEMBERS REPORT(BOLGATANGA)',0,1);
    }
