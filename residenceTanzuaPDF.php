...
$query = "SELECT * from  members where residence LIKE '%Tanz%' ";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE MEMBERS FROM TANZUA REPORT(BOLGATANGA)',0,1);
    }
