...
$query = "SELECT * from  members where department = 'Joy Fellowship'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE JOY FELLOWSHIP MEMBERS REPORT(BOLGATANGA)',0,1);
    }
