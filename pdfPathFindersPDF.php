...
$query = "SELECT * from  members where department = 'PathFinders'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE PATHFINDERS MEMBERS REPORT (BOLGATANGA)',0,1);
    }
