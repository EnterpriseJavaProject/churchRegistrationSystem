...
$query = "SELECT * from  members where department = 'Youth Ministry'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE YOUTH MINISTRY MEMBERS REPORT(BOLGATANGA)',0,1);
    }
