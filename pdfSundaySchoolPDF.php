...
$query = "SELECT * from  members where department = 'Sunday School'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE SUNDAY SCHOOL DEPT REPORT(BOLGATANGA)',0,1);
    }
