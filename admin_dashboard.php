                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-primary" href="viewAllMembersPage.php">
                                            <?php
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="viewAllMaleMembersPage.php">
                                            <?php
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="viewAllAdminPage.php">
                                        <?php

                                        $sql3 = "SELECT id from members where tithe >= 1";
                                        $query3 = $dbh->prepare($sql3);
                                        $query3->execute();
                                        $results3 = $query3->fetchAll(PDO::FETCH_OBJ);
                                        $totalTithePayers = $query3->rowCount();
                                        ?>

                                        <span class="number counter"><?php echo htmlentities($totalTithePayers); ?></span>
                                        <span class="name">Tithes Payers</span>
                                        <span class="bg-icon"><i class="fa fa-users"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                ...
                                <ul class="bars">
                                    <li>
                                        <div class="bar" data-percentage="<?php
                                                                            ...
                                                                            echo '' . $row . '';
                                                                            ?>">
                                        </div><span><a href="viewAllMembersPage.php">All Members</a></span>
                                    </li>
                                    ...
                                    <li>
                                        <div class="bar" data-percentage="<?php
                                                                            ...
                                                                            echo '' . $row . '';
                                                                            ?>">
                                        </div><span><a href="viewAllAdminPage.php">Admins</a></span>
                                    </li>
