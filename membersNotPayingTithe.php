...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
 <h5><big>ALL MEMBERS NOT PAYING TITHE DASHBOARD</big></h5>
...
<marquee behavior="" direction=""><h5><big>ASSEMBLIES OF GOD | HOLY GHOST TEMPLE ALL MEMBERS NOT PAYING TITHE DASHBOARD</big></h5></marquee> 
...
<div class="card shadow mb-4">
    ...
    <div class="card shadow mb-4">
        <div class="card-header text-center py-3">
          <h6 class="m-0 font-weight-bold text-primary">ASSEMBLIES OF GOD | HOLY GHOST TEMPLE MEMBERS NOT PAYING TITHE DATATABLE</h6>
        </div>
        ...
        <?php
            ...
            $query = "SELECT * FROM members where tithe <= 0";
            $query_run = mysqli_query($connection, $query);
