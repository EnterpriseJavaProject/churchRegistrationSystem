...
$query = "SELECT * from  members where department = 'Mission Team'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE MISSION TEAM MEMBERS REPORT(BOLGATANGA)',0,1);
    }
