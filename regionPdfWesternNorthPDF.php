...
$query = "SELECT * from  members where region = 'Western North'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD | HOLY GHOST TEMPLE MEMBERS FROM WESTERN NORTH REPORT(BOLGATANGA)',0,1);
    }
