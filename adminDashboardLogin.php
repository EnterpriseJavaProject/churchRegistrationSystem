...
<button type="submit" name="admindashboardlogin_btn" onclick="return validate()" <?php if($atmp == 3) { ?> hidden="hidden" <?php  } ?> class="btn btn-primary text-light text-center btn-outline-success btn-user btn-block">Login</button>
                <hr>
