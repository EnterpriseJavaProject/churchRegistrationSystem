...
$query = "SELECT * from  members where residence LIKE '%Kumbosi%' ";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE MEMBERS FROM KUMBOSICO REPORT(BOLGATANGA)',0,1);
    }
