...
$query = "SELECT * from  members where year_baptised = 'No'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE MEMBERS NOT BAPTISED REPORTS (BOLGATANGA)',0,1);
    }
...
if (isset($_POST['btn_pdf']))
 {
   ...
   while ($row = mysqli_fetch_assoc($query_run)) 
   {
       ...
       $pdf->cell('35', '10', $row['residence'], '1', '0', 'C');
       $pdf->cell('32', '10', $row['department'], '1', '0', 'C');
       $pdf->cell('35', '10', $row['occupation'], '1', '0', 'C');
       $pdf->cell('52', '10', $row['place_of_work'], '1', '0', 'C');
