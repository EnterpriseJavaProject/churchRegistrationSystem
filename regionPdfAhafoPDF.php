...
$query = "SELECT * from  members where region = 'Ahafo'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE MEMBERS FROM AHAFO REGION REPORT(BOLGATANGA)',0,1);
    }
