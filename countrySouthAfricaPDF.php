...
$query = "SELECT * from  members where country = 'South Africa'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA| HOLY GHOST TEMPLE MEMBERS FROM SOUTH AFRICA REPORT(BOLGATANGA)',0,1);
    }
