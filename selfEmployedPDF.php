...
$query = "SELECT * from members WHERE occupation LIKE '%Self%' ";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD GHANA | HOLY GHOST TEMPLE SELF EMPLOYED MEMBERS REPORT(BOLGATANGA)',0,1);
    }
...
if (isset($_POST['btn_pdf']))
 {
     ...
     $pdf->cell('40', '10', 'WORK PLACE', '1', '0', 'C');
     $pdf->cell('35', '10', 'HOME TOWN', '1', '0', 'C');
    ...
    while ($row = mysqli_fetch_assoc($query_run)) 
    {
        ...
        $pdf->cell('40', '10', $row['place_of_work'], '1', '0', 'C');
        $pdf->cell('35', '10', $row['home_town'], '1', '0', 'C');
