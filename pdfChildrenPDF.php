...
$query = "SELECT * from  members where department = 'Children'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE CHILDREN DEPT MEMBERS REPORT(BOLGATANGA)',0,1);
    }
