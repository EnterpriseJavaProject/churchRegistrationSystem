...
<li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="atebubu_amantin.php">Atebubu/Amantin</a>:</h6>
            <a class="collapse-item" href="atebubu_amantin_npp.php">NPP</a>
            <a class="collapse-item" href="atebubu_amantin_ndc.php">NDC</a>
            <a class="collapse-item" href="atebubu_amantin_others.php">OTHERS</a>
          </div>
        </div>
      </li>
...
<li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="kintampo_north.php">Kintampo North</a>:</h6>
...
<li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="kintampo_south.php">Kintampo South</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="nkoranza_north.php">Nkoranza North</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="nkoranza_south.php">Nkoranza South</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="pru_east.php">Pru East</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="pru_west.php">Pru West</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="sene_east.php">Sene East</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="sene_west.php">Sene West</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="techiman_north.php">Techiman North</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="techiman_south.php">Techiman South</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
