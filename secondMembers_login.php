...
<?php unset($_SESSION["error"]);  } ?>
        ...
        <input type="number" name="phone" id="phone" class="form-control form-control-user" autocomplete="off" placeholder="Enter Phone Number" required="required">
...
<button type="submit" name="locked" onclick="return validate()" class="btn btn-primary text-light text-center btn-outline-success btn-user btn-block">Login</button>
