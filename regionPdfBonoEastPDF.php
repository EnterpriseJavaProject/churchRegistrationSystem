...
$query = "SELECT * from  members where region = 'Bono East'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE MEMBERS FROM BONO EAST REPORT(BOLGATANGA)',0,1);
    }
