...
$query = "SELECT * from  members where department = 'Young Singles'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE YOUNG SINGLES MEMBERS REPORT(BOLGATANGA)',0,1);
    }
