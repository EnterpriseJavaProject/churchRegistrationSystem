...
$query = "SELECT * from  members where department = 'Women Ministry'";
...
class PDF extends FPDF{
    function Header(){
        ...
        $this->cell(100,10,'ASSEMBLIES OF GOD CHURCH | HOLY GHOST TEMPLE WOMEN MINISTRY MEMBERS REPORT(BOLGATANGA)',0,1);
    }
